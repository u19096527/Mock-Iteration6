...
getFilteredAuditTrail(){
  ...
  downloadAuditTrailReport() {
    ...
    let text = "";
    if (this.arrAuditTrails == null || this.arrAuditTrails.length<0) {
     ...
     const maxWidth = 80; // Adjust the maximum width of the text
    ...
    newTrail.auditEntryTypeID = 57;
    newTrail.comment = "Visited the Audit Trail page"      
