...
export class CheckBookEstimateComponent {
  cart: number = 5;
  constructor(private dataService: DataService, private router: Router, private activated: ActivatedRoute, private renderer: Renderer2, private elementRef: ElementRef) { }
